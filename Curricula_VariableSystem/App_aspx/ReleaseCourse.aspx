<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReleaseCourse.aspx.cs" Inherits="Curricula_VariableSystem.App_aspx.ReleaseCourse" %>
...
<asp:BulletedList ID="BulletedList1" runat="server" DisplayMode="HyperLink"  CssClass="style2" Height="45px" Width="100%" BorderStyle="NotSet">
        ...
        <h2 style="text-align:center">填写发布课程信息</h2>
        <table style="width: 100%; ">
            <tr>
                <td class="auto-style3">课程编号：<asp:TextBox ID="TextBox1" runat="server" style="vertical-align:middle;" AutoPostBack="True" OnTextChanged="TextBox1_TextChanged" MaxLength="3"  ></asp:TextBox>
                    *</td>
                <td class="auto-style5">课程名称：<asp:TextBox ID="TextBox2" runat="server" style="vertical-align:middle;" ></asp:TextBox>*
                    </td>
                <td>课程类别：<asp:ListBox ID="ListBox1" runat="server" style="vertical-align:middle;" Rows="1" >
            ...
            <tr>
                <td class="auto-style2">学&nbsp;&nbsp;分：<asp:ListBox ID="ListBox2" runat="server" style="vertical-align:middle;" Rows="1" >
                ...
                <td class="auto-style6">上课时间：<asp:ListBox ID="ListBox3" runat="server" style="vertical-align:middle;" Rows="1" >
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td><asp:Button ID="Button2" runat="server" Text="重 置" Width="98px" OnClick="Button2_Click"  /></td>
            </tr>
        </table>
    </form>
</body>
