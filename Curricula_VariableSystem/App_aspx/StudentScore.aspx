<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentScore.aspx.cs" Inherits="Curricula_VariableSystem.App_aspx.StudentScore" %>
...
<asp:BulletedList ID="BulletedList1" runat="server" DisplayMode="HyperLink"  CssClass="style2" Height="45px" Width="100%" BorderStyle="NotSet">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" AllowPaging="True" >
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CVSDBConnectionString2 %>" SelectCommand="SELECT [课程名称], [成绩] FROM [View_SScore] WHERE ([学号] = @学号)">
              <SelectParameters>
