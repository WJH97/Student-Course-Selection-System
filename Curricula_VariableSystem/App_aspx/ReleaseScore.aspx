<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReleaseScore.aspx.cs" Inherits="Curricula_VariableSystem.App_aspx.ReleaseScore" %>
...
<asp:BulletedList ID="BulletedList1" runat="server" DisplayMode="HyperLink"  CssClass="style2" Height="45px" Width="100%" BorderStyle="NotSet">
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="课程名称" DataNavigateUrlFormatString="ReleaseScore01.aspx?课程名称={0}" DataTextField="课程名称" HeaderText="课程名称" />
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CVSDBConnectionString2 %>" SelectCommand="SELECT [课程名称], [课程类别], [上课时间], [上课地点] FROM [Course] WHERE (([发布状态] = @发布状态) AND ([教师工号] = @教师工号))">
            <SelectParameters>
